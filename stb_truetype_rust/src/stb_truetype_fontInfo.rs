...
pub unsafe fn stbtt__get_svg(info: *mut stbtt_fontinfo) -> i32 {
    let mut t: u32 = 0;
    if (*info).svg < 0 {
        t = stbtt__find_table((*info).data, ((*info).fontstart) as u32, obfstr!("SVG "));
        if (t) != 0 {
...
pub unsafe fn stbtt__GetCoverageIndex(coverageTable: *const u8, glyph: i32) -> i32 {
    let coverageFormat: u16 = ttUSHORT(coverageTable);
    if ((coverageFormat) as i32) == 1 {
        let glyphCount: u16 = ttUSHORT((coverageTable).offset((2) as isize));
        let mut l: i32 = 0;
        let mut r: i32 = ((glyphCount) as i32) - 1;
        let mut m: i32 = 0;
        let mut straw: i32 = 0;
        let needle: i32 = glyph;
        while l <= r {
            let glyphArray: *const u8 = (coverageTable).offset((4) as isize);
        ...
        let rangeCount: u16 = ttUSHORT((coverageTable).offset((2) as isize));
        let rangeArray: *const u8 = (coverageTable).offset((4) as isize);
        let mut l: i32 = 0;
        ...
        while l <= r {
            ...
            if needle < strawStart {
                ...
                if needle > strawEnd {
                    ...
                    let startCoverageIndex: u16 = ttUSHORT((rangeRecord).offset((4) as isize));
...
pub unsafe fn stbtt__GetGlyfOffset(info: *mut stbtt_fontinfo, glyph_index: i32) -> i32 {
    let mut g1: i32 = 0;
    let mut g2: i32 = 0;
...
pub unsafe fn stbtt__GetGlyphClass(classDefTable: *const u8, glyph: i32) -> i32 {
    let classDefFormat: u16 = ttUSHORT(classDefTable);
    if ((classDefFormat) as i32) == 1 {
        let startGlyphID: u16 = ttUSHORT((classDefTable).offset((2) as isize));
        let glyphCount: u16 = ttUSHORT((classDefTable).offset((4) as isize));
        let classDef1ValueArray: *const u8 = (classDefTable).offset((6) as isize);
        ...
        let classRangeCount: u16 = ttUSHORT((classDefTable).offset((2) as isize));
        let classRangeRecords: *const u8 = (classDefTable).offset((4) as isize);
        let mut l: i32 = 0;
...
pub unsafe fn stbtt__GetGlyphGPOSInfoAdvance(
    ...
    while i < ((lookupCount) as i32) {
        let lookupOffset: u16 =
            ttUSHORT(((lookupList).offset((2) as isize)).offset((2 * i) as isize));
        let lookupTable: *const u8 = (lookupList).offset(((lookupOffset) as i32) as isize);
        let lookupType: u16 = ttUSHORT(lookupTable);
        let subTableCount: u16 = ttUSHORT((lookupTable).offset((4) as isize));
        let subTableOffsets: *const u8 = (lookupTable).offset((6) as isize);
        ...
        while sti < ((subTableCount) as i32) {
            let subtableOffset: u16 = ttUSHORT((subTableOffsets).offset((2 * sti) as isize));
            let table: *const u8 = (lookupTable).offset(((subtableOffset) as i32) as isize);
            let posFormat: u16 = ttUSHORT(table);
            let coverageOffset: u16 = ttUSHORT((table).offset((2) as isize));
            let coverageIndex: i32 =
            ...
            if ((posFormat) as i32) == 1 {
                ...
                let valueFormat1: u16 = ttUSHORT((table).offset((4) as isize));
                let valueFormat2: u16 = ttUSHORT((table).offset((6) as isize));
                if ((valueFormat1) as i32) == 4 && ((valueFormat2) as i32) == 0 {
                    let valueRecordPairSizeInBytes: i32 = 2;
                    let pairSetCount: u16 = ttUSHORT((table).offset((8) as isize));
                    let pairPosOffset: u16 = ttUSHORT(
                        ((table).offset((10) as isize)).offset((2 * coverageIndex) as isize),
                    );
                    let pairValueTable: *const u8 =
                        (table).offset(((pairPosOffset) as i32) as isize);
                    let pairValueCount: u16 = ttUSHORT(pairValueTable);
                    let pairValueArray: *const u8 = (pairValueTable).offset((2) as isize);
                    ...
                    while l <= r {
                        ...
                        if needle < straw {
                            ...
                            if needle > straw {
                                ...
                                let xAdvance: i16 = ttSHORT((pairValue).offset((2) as isize));
                ...
                let valueFormat2: u16 = ttUSHORT((table).offset((6) as isize));
                if ((valueFormat1) as i32) == 4 && ((valueFormat2) as i32) == 0 {
                    let classDef1Offset: u16 = ttUSHORT((table).offset((8) as isize));
                    let classDef2Offset: u16 = ttUSHORT((table).offset((10) as isize));
                    let glyph1class: i32 = stbtt__GetGlyphClass(
                        (table).offset(((classDef1Offset) as i32) as isize),
                        glyph1,
                    );
                    let glyph2class: i32 = stbtt__GetGlyphClass(
                        (table).offset(((classDef2Offset) as i32) as isize),
                        glyph2,
                    );
                    let class1Count: u16 = ttUSHORT((table).offset((12) as isize));
                    let class2Count: u16 = ttUSHORT((table).offset((14) as isize));
...
pub unsafe fn stbtt__GetGlyphInfoT2(
    ...
    c.bounds = 1;
    let r: i32 = stbtt__run_charstring(info, glyph_index, (&mut c) as *mut stbtt__csctx);
...
pub unsafe fn stbtt__GetGlyphKernInfoAdvance(
    ...
    let data: *const u8 = ((*info).data).offset(((*info).kern) as isize);
    ...
    *pvertices = core::ptr::null_mut();
    ...
    if ((numberOfContours) as i32) > 0 {
        ...
        while i < n {
            ...
            if (((flags) as i32) & 2) != 0 {
                let dx: i16 = (*c_runtime::postIncConstPtr(&mut points)) as i16;
        ...
        while i < n {
            flags = ((*vertices.offset((off + i) as isize))._type_) as u8;
            if (((flags) as i32) & 4) != 0 {
                let dy: i16 = (*c_runtime::postIncConstPtr(&mut points)) as i16;
            ...
            while (more) != 0 {
                ...
                if comp_num_verts > 0 {
                    ...
                    while i < comp_num_verts {
                        let v: *mut stbtt_vertex = &mut *comp_verts.offset((i) as isize);
                        let mut x: i16 = 0;
                        let mut y: i16 = 0;
                        x = ((*v).x) as i16;
                        y = ((*v).y) as i16;
                ...
                if ((format) as i32) == 4 {
                    ...
                    let rangeShift: u16 =
                        (((ttUSHORT(((data).offset((index_map) as isize)).offset((12) as isize)))
                            as i32)
                            >> 1) as u16;
                    let endCount: u32 = index_map + ((14) as u32);
                    ...
                    search += (2) as u32;
                    {
                        ...
                        let mut start: u16 = 0;
                        let mut last: u16 = 0;
                        let item: u16 = ((search - endCount) >> 1) as u16;
                        start = (ttUSHORT(
...
pub unsafe fn stbtt_FindSVGDoc(info: *mut stbtt_fontinfo, gl: i32) -> *const u8 {
    let mut i: i32 = 0;
    let data: *const u8 = (*info).data;
    let svg_doc_list: *const u8 =
        (data).offset((stbtt__get_svg((info) as *mut stbtt_fontinfo)) as isize);
    let numEntries: i32 = (ttUSHORT(svg_doc_list)) as i32;
    let svg_docs: *const u8 = (svg_doc_list).offset((2) as isize);
    i = (0) as i32;
    while i < numEntries {
        let svg_doc: *const u8 = (svg_docs).offset((12 * i) as isize);
...
pub unsafe fn stbtt_FreeShape(_info: *mut stbtt_fontinfo, v: *mut stbtt_vertex) {
...
pub unsafe fn stbtt_GetFontNameString(
    ...
    let nm: u32 = stbtt__find_table(fc, offset, obfstr!("name"));
    if nm == 0 {
...
pub unsafe fn stbtt_GetFontVMetricsOS2(
    ...
    let tab: i32 =
        (stbtt__find_table((*info).data, ((*info).fontstart) as u32, obfstr!("OS/2"))) as i32;
    if tab == 0 {
        return (0) as i32;
    }
    ...
    scale_y = (-scale_y) as f32;
    {
        ...
        while i < num_verts {
            if (((*verts.offset((i) as isize))._type_) as i32) == STBTT_vline {
                ...
                let x1: f32 = ((((*verts.offset((j) as isize)).x) as i32) as f32) * scale_x;
                let y1: f32 = ((((*verts.offset((j) as isize)).y) as i32) as f32) * scale_y;
                let dist: f32 =
                ...
                *precompute.offset((i) as isize) = if dist == ((0) as f32) {
                ...
                if (((*verts.offset((i) as isize))._type_) as i32) == STBTT_vcurve {
                    ...
                    let by: f32 = y0 - ((2) as f32) * y1 + y2;
                    let len2: f32 = bx * bx + by * by;
                    if len2 != 0.0f32 {
            ...
            while x < ix1 {
                ...
                while i < num_verts {
                        ...
                        && *precompute.offset((i) as isize) != 0.0f32
                    {
                        ...
                        let dist2: f32 = (x0 - sx) * (x0 - sx) + (y0 - sy) * (y0 - sy);
                        ...
                        if dist < min_dist {
                            ...
                            let px: f32 = x0 - sx;
                            let py: f32 = y0 - sy;
                            let t: f32 = -(px * dx + py * dy) / (dx * dx + dy * dy);
                        ...
                        if (((*verts.offset((i) as isize))._type_) as i32) == STBTT_vcurve {
                                ...
                                && sy < box_y1 + min_dist
                            {
                                ...
                                let a_inv: f32 = *precompute.offset((i) as isize);
                                if ((a_inv) as f64) == 0.032 {
                                    let a: f32 = ((3) as f32) * (ax * bx + ay * by);
                                    let b: f32 =
                                        ((2) as f32) * (ax * ax + ay * ay) + (mx * bx + my * by);
                                    let c: f32 = mx * ax + my * ay;
                                    if ((a) as f64) == 0.032 {
                                        if ((b) as f64) != 0.032 {
                                    ...
                                    let b: f32 = ((3) as f32) * (ax * bx + ay * by) * a_inv;
                                    let c: f32 = (((2) as f32) * (ax * ax + ay * ay)
                                        + (mx * bx + my * by))
                                        * a_inv;
                                    let d: f32 = (mx * ax + my * ay) * a_inv;
...
pub unsafe fn stbtt_GetKerningTableLength(info: *mut stbtt_fontinfo) -> i32 {
    let data: *const u8 = ((*info).data).offset(((*info).kern) as isize);
    if (*info).kern == 0 {
        return (0) as i32;
    }
...
pub unsafe fn stbtt_InitFont_internal(
    ...
    cmap = stbtt__find_table(data, (fontstart) as u32, obfstr!("cmap"));
    (*info).loca = (stbtt__find_table(data, (fontstart) as u32, obfstr!("loca"))) as i32;
    (*info).head = (stbtt__find_table(data, (fontstart) as u32, obfstr!("head"))) as i32;
    (*info).glyf = (stbtt__find_table(data, (fontstart) as u32, obfstr!("glyf"))) as i32;
    (*info).hhea = (stbtt__find_table(data, (fontstart) as u32, obfstr!("hhea"))) as i32;
    (*info).hmtx = (stbtt__find_table(data, (fontstart) as u32, obfstr!("hmtx"))) as i32;
    (*info).kern = (stbtt__find_table(data, (fontstart) as u32, obfstr!("kern"))) as i32;
    (*info).gpos = (stbtt__find_table(data, (fontstart) as u32, obfstr!("GPOS"))) as i32;
    ...
    if ((*info).glyf) != 0 {
        ...
        let mut cff: u32 = 0;
        cff = stbtt__find_table(data, (fontstart) as u32, obfstr!("CFF "));
        if cff == 0 {
            return (0) as i32;
        }
    ...
    t = stbtt__find_table(data, (fontstart) as u32, obfstr!("maxp"));
    if (t) != 0 {
    ...
    i = (0) as i32;
    while i < numTables {
        let encoding_record: u32 = cmap + ((4) as u32) + ((8 * i) as u32);
...
pub unsafe fn stbtt_IsGlyphEmpty(info: *mut stbtt_fontinfo, glyph_index: i32) -> i32 {
    let mut numberOfContours: i16 = 0;
    let mut g: i32 = 0;
    if ((*info).cff.size) != 0 {
...
pub unsafe fn stbtt_PackFontRangesGatherRects(
    ...
    i = (0) as i32;
    while i < num_ranges {
        let fh: f32 = (*ranges.offset((i) as isize)).font_size;
        let scale: f32 = if fh > ((0) as f32) {
        ...
        while j < (*ranges.offset((i) as isize)).num_chars {
            ...
            let glyph: i32 = stbtt_FindGlyphIndex(info, codepoint);
...
pub unsafe fn stbtt_PackFontRangesRenderIntoRects(
    ...
    let old_h_over: i32 = ((*spc).h_oversample) as i32;
    let old_v_over: i32 = ((*spc).v_oversample) as i32;
    k = (0) as i32;
    i = (0) as i32;
    while i < num_ranges {
        let fh: f32 = (*ranges.offset((i) as isize)).font_size;
        ...
        j = (0) as i32;
        while j < (*ranges.offset((i) as isize)).num_chars {
            let r: *mut stbrp_rect = &mut *rects.offset((k) as isize);
            if ((*r).was_packed) != 0 && (*r).w != 0 && (*r).h != 0 {
                let bc: *mut stbtt_packedchar = &mut *(*ranges.offset((i) as isize))
                    .chardata_for_range
                    .offset((j) as isize);
...
pub unsafe fn stbtt_ScaleForPixelHeight(info: *mut stbtt_fontinfo, height: f32) -> f32 {
    let fheight: i32 =
        ((ttSHORT((((*info).data).offset(((*info).hhea) as isize)).offset((4) as isize))) as i32)
